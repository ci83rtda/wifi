...
@section('content')
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            <a href="{{ route('wifi.form') }}" class="font-medium text-indigo-600 hover:text-indigo-500">regresar</a>.
        </p>
    </div>
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form class="space-y-6" action="{{ route('wifi.process') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="first_name" name="first_name" type="text" placeholder="Nombres" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="last_name" name="last_name" type="text" autocomplete="Apellidos" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    <label for="location" class="block text-sm font-medium text-gray-700">Tipo de Identificacion</label>
                    <select id="location" name="location" required class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        <option>Cedula de Ciudadania</option>
                        <option>NIT</option>
                        <option>Cedula de Extrangeria</option>
                        <option>Numero de Passaporte</option>
                    </select>
                </div>

                <div>
                    <label for="identification" class="block text-sm font-medium text-gray-700">Numero de Identificacion</label>
                    <div class="mt-1">
                        <input id="identification" name="identification" type="number" autocomplete="Numero de Identificacion" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                    </div>
                </div>
